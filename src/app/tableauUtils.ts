...
const PARAMS = [
  ...
  { name: "site_root", value: "" },
  {
    name: "name",
    value:
      "Honkai_StarRailIn-AppPurchaseAnalysis/HonkaiStarRailIn-AppPurchaseAnalysis",
  },
  { name: "tabs", value: "yes" },
  { name: "toolbar", value: "yes" },
  {
    name: "static_image",
    value:
      "https://public.tableau.com/static/images/Ho/Honkai_StarRailIn-AppPurchaseAnalysis/HonkaiStarRailIn-AppPurchaseAnalysis/1.png",
  },
...
export function createNoscriptFallback() {
  ...
  fallbackImg.src =
    "https://public.tableau.com/static/images/Ho/Honkai_StarRailIn-AppPurchaseAnalysis/HonkaiStarRailIn-AppPurchaseAnalysis/1_rss.png";
