...
describe('Dashboard Component Integration', () => {
  it('should call tableauUtils functions during initialization', () => {
    ...
    const createNoscriptFallbackSpy = vi.spyOn(tableauUtils, 'createNoscriptFallback');
    ...
    expect(loadScriptSpy).toHaveBeenCalledWith(expect.any(String), expect.any(Function));
